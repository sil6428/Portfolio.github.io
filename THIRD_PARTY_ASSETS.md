...
The source geometry is retained, but the portfolio replaces the active models' imported surface maps at runtime with smooth physically based materials and a limited dark-studio palette. The bookshelf is an original scene object rather than an external model.
